...
$(".unique_box").on("mouseenter", function () {

    var $card = $(this);
    var $slider = $card.find(".product_carousel");

    // Make sure any previous timer is cleared
    clearInterval($card.data("hoverSlider"));
    ...
    // Save timer on this card
    $card.data("hoverSlider", hoverSlider);

});


$(".unique_box").on("mouseleave", function () {
